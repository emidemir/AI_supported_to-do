		...
		<AppBar>
			<Toolbar>
				...
				<Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } , gap:10, justifyContent:"space-around"}}>
					<Button variant="text" color="inherit" size="large">TO DO</Button>
					<Button variant="text" color="inherit" size="large">SO FAR</Button>
					<Button variant="text" color="inherit" size="large">STATISTICS</Button>
				</Box>
				{/*PROFILE OPERATIONS*/}
				<Box sx={{ flexGrow: 0 }}>
